    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="fw-bold">Dietry Restriction Manage</h4>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addRoleModal">
                    <i class="ri-add-line"></i> Add Restriction
                </button>
            </div>
                    ...
                    <form id="createRestrictionForm">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addRoleModalLabel">Add New Restriction</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="roleName" class="form-label">Restriction Name</label>
                                    <input type="text" class="form-control" id="roleName" name="name" placeholder="Enter restriction name">
                                    @error('name')
                            ...
                            <div class="modal-footer">
                                ...
                                <a  class="btn btn-primary create">Create Restriction</a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <label for="role_name" class="form-label">Restriction Name</label>
...
<script>
    $(document).ready(function() {
        $('#rolesTable').DataTable({
            processing: true,
            serverSide: true,
             ajax:"{{ route('getDietryRestrictions') }}",
             columns:[
...
$(document).on('click', '.create', function (e) {
    ...
    let formData = new FormData($('#createRestrictionForm')[0]);
    $.ajaxSetup({
        headers: {  'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }
    });
    $.ajax({
        url: "{{ route('restriction.store') }}",
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
